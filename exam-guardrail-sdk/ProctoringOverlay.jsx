...
/**
 * ProctoringOverlay — Renders a floating camera + audio bar overlay.
 *
 * Props:
 *   videoStream  — MediaStream from GuardrailSDK.getVideoStream()
 *   faceStatus   — 'ok' | 'no_face' | 'looking_away'
 *   audioLevel   — 0–100 number
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        ...
        <button
          ...
          style={{
            ...
            fontSize: 14, lineHeight: 1, padding: '0 2px', opacity: 0.5
          }}
        >
          {hidden ? '◻' : '▬'}
        </button>
        ...
        <>
          <div style={{ position: 'relative', borderRadius: 8, overflow: 'hidden', ...size }}>
            ...
            <div style={{
              ...
              <span style={{ fontSize: 9, textShadow: '0 1px 3px rgba(0,0,0,0.8)' }}>
                {statusLabel}
              </span>
            </div>
          </div>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
            ...
            <div style={{
              flex: 1, height: 6, background: 'rgba(255,255,255,0.15)', borderRadius: 3, overflow: 'hidden'
            }}>
              <div style={{
            ...
            <span style={{ fontSize: 9, opacity: 0.5, width: 20, textAlign: 'right' }}>
              {audioLevel}
            </span>
          </div>
        </>
